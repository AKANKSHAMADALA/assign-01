...
for j in range(n):
  ...
  d.update({'Roll num':'0183'})
  d.update({'Branch':'cse'})
  d.update({'Specialization':'core'})
  d.update({'Email-Id':'makanksh@gitam.in'})
  d.update({'Replit-Id':'MADALA_Akanksha'})
  d.update({'GitHub-Id':'akanksha.m'})
  d.update({'Moodle-Id':'VU21csen0100183'})
  d.update({'Semester':'2'})
  d.update({'Year':'1'})
  return d
